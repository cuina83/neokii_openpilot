...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: Alert(
      ...
      "항상 핸들을 잡고 도로를 주시하세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeReady, 5., 0., 15.),
  },
  ...
  EventName.carUnrecognized: {
    ET.PERMANENT: Alert(
      ...
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWEST, VisualAlert.none, AudibleAlert.chimeError, 0.5, 0., .2),
  },
  ...
  EventName.vehicleModelInvalid: {
    ET.WARNING: Alert(
      ...
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOWEST, VisualAlert.steerRequired, AudibleAlert.chimeDing, .5, .0, .1),
  },
  ...
  EventName.sensorDataInvalid: {
    ET.PERMANENT: Alert(
      ...
      "장치 점검후 재가동세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeError, 0.5, 0., .2, creation_delay=1.),
  ...
  EventName.commIssue: {
    ...
    ET.NO_ENTRY: NoEntryAlert("장치 프로세스 통신오류",
                              audible_alert=AudibleAlert.chimeError),
  },
