...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: Alert(
      ...
      "항상 핸들을 잡고 도로를 주시하세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeReady, 5.5, 0., 15.),
  },
  ...
  EventName.startupNoControl: {
    ET.PERMANENT: Alert(
      ...
      "항상 핸들을 잡고 도로를 주시하세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeDing, .2, 0., 15.),
  },
  ...
  EventName.preDriverDistracted: {
    ET.WARNING: Alert(
      ...
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.steerRequired, AudibleAlert.chimeDistracted, 5., .1, .1, alert_rate=0.75),
  },
  ...
  EventName.steerSaturated: {
    ET.WARNING: Alert(
      ...
      "조향제어 제한을 초과함",
      AlertStatus.userPrompt, AlertSize.mid,
      Priority.LOW, VisualAlert.steerRequired, AudibleAlert.chimeDing, .2, 1., 1.),
  },
  ...
  EventName.brakeHold: {
    ET.PERMANENT: Alert(
      ...
      "",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeAutohold, 2., 0., 2.),
  },
